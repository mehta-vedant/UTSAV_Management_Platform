...
export default function DashboardHeader({ organization, role }: DashboardHeaderProps) {
    ...
    return (
        <div className="flex flex-col gap-5 border-b border-slate-100 pb-6 sm:pb-8 lg:flex-row lg:items-end lg:justify-between">
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                ...
                {organization.type === "FESTIVAL" && (
                    <div className="flex w-full items-center rounded-2xl border border-slate-200 bg-white p-1 shadow-sm animate-in fade-in slide-in-from-right-4 duration-500 sm:w-auto">
                        <Link
                            href={`/${organization.slug}`}
                            target="_blank"
                            className="flex flex-1 items-center justify-center gap-2 rounded-xl border-r border-slate-100 px-4 py-2 text-slate-600 transition-colors hover:bg-slate-50 sm:flex-none"
                        >
